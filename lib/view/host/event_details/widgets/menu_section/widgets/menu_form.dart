...
import 'package:traxx_wepapp/view/host/event_details/widgets/menu_section/widgets/upload_photo.dart';
          ...
          child: Column(
            children: [
              ...
              DropdownButtonFormField<MenuCategory>(
                value: MenuCategory.values.firstWhere((e) => e == item.category,
                    orElse: () => MenuCategory.other),
                onChanged: (value) {
                  setMenusController.changeMenuCategory(item.id, value!);
                },
