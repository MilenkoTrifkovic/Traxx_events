...
//       // -----------------------------
//       // -----------------------------
// // 5) Fetch questions (SAFE: no where(isDisabled), no orderBy)
// // -----------------------------
...
// // ✅ Filter disabled locally (missing field => enabled)
//       final questionDocs = qSnap.docs.where((d) {
//         final data = d.data();
//         return _asBool(data['isDisabled'], fallback: false) != true;
//       }).toList();

// // ✅ Sort locally by displayOrder
//       questionDocs.sort((a, b) {
//         final da = _asInt(a.data()['displayOrder'], fallback: 0);
//         final db = _asInt(b.data()['displayOrder'], fallback: 0);
...
//       // -----------------------------
// // 6) Fetch options (SAFE: no where(isDisabled), no orderBy)
// // -----------------------------
...
//           // ✅ Filter disabled locally (missing field => enabled)
//           if (_asBool(data['isDisabled'], fallback: false) == true) continue;
